...
/*
 * Plugin Name: Jetpack Contact Form
 * Plugin URI: http://wordpress.org/extend/plugins/jetpack/
 * Description: Add a contact form to any post, page or text widget.  Emails will be sent to the post's author by default, or any email address you choose.  Forked from JETPACK.
 * Version: 3.4.1
 * Author: BlogSynthesis
 * Author URI: http://www.blogsynthesis.com/plugins/contact-form/
...
/*********************************************************
 *
 *    NOTE: THIS PLUGIN SHOULD NEVER BE USED ALONG WITH
 *       JETPACK OR GRUNION CONTACT FORM PLUGINS.
 *             
 *
 *    DISCLAIMER: This plugin is 99.999% based on JETPACK Contact form module.
 *
 **********************************************************/

define( 'CONTACT_FORM_VERSION', '3.4.1' );
